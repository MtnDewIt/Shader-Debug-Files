...
namespace TagTool.Commands.Shaders
{
    ...
    public class DumpDisassembledShadersCommand : Command
    {
        ...
        private string DisassemblePCShader(object definition, int shaderIndex, string filename)
        {
            ...
            // Some pc shaders are using the DX9 compiler, instead of the HLSL compiler. Patching this just makes diffing shaders a little easier
            disassembly = disassembly.Replace("Generated by Microsoft (R) D3DX9 Shader Compiler ", "Generated by Microsoft (R) HLSL Shader Compiler 9.29.952.3111");
            
            // For some reason, some of the shaders contain NaN values, which aren't supported by the compiler, so we can just ignore them
            disassembly = disassembly.Replace(".#IND", "");
